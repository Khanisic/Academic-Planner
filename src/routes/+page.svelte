...
<div class="flex h-full relative top-0">
	...
	<div
		class="bg-leftBar w-[200px] top-0 absolute z-40 dark:bg-black rounded-l-xl border-r-lightBorder dark:border-r-darkBorder border-t-0 border-b-0 border-l-0 border-[1px] h-full  transition-transform duration-300 ease-in-out"
